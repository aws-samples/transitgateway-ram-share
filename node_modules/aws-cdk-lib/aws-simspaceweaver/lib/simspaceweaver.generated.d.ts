...
export interface CfnSimulationProps {
     ...
     */
    readonly schemaS3Location?: CfnSimulation.S3LocationProperty | cdk.IResolvable;
    /**
     ...
     */
    readonly snapshotS3Location?: CfnSimulation.S3LocationProperty | cdk.IResolvable;
}
/**
...
export declare class CfnSimulation extends cdk.CfnResource implements cdk.IInspectable {
     ...
     */
    static readonly CFN_RESOURCE_TYPE_NAME = "AWS::SimSpaceWeaver::Simulation";
    /**
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-simspaceweaver-simulation.html#cfn-simspaceweaver-simulation-schemas3location
     */
    schemaS3Location: CfnSimulation.S3LocationProperty | cdk.IResolvable | undefined;
    /**
     * The location of the snapshot in Amazon Simple Storage Service ( Amazon S3 ). For more information about Amazon S3 , see the [*Amazon Simple Storage Service User Guide*](https://docs.aws.amazon.com/AmazonS3/latest/userguide/Welcome.html) .
     *
     * Provide a `SnapshotS3Location` to start your simulation from a snapshot.
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-simspaceweaver-simulation.html#cfn-simspaceweaver-simulation-snapshots3location
     */
    snapshotS3Location: CfnSimulation.S3LocationProperty | cdk.IResolvable | undefined;
    /**
