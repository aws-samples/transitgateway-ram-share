...
export interface CfnDBClusterProps {
     ...
     */
    readonly serverlessScalingConfiguration?: CfnDBCluster.ServerlessScalingConfigurationProperty | cdk.IResolvable;
    /**
...
export declare class CfnDBCluster extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-neptune-dbcluster.html#cfn-neptune-dbcluster-serverlessscalingconfiguration
     */
    serverlessScalingConfiguration: CfnDBCluster.ServerlessScalingConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Specifies the identifier for a DB cluster snapshot. Must match the identifier of an existing snapshot.
     *
     * After you restore a DB cluster using a `SnapshotIdentifier` , you must specify the same `SnapshotIdentifier` for any future updates to the DB cluster. When you specify this property for an update, the DB cluster is not restored from the snapshot again, and the data in the database is not changed.
