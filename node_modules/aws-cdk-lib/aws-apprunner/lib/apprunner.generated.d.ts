...
export declare class CfnAutoScalingConfiguration extends cdk.CfnResource implements cdk.IInspectable {
     ...
     */
    static readonly CFN_RESOURCE_TYPE_NAME = "AWS::AppRunner::AutoScalingConfiguration";
    /**
...
export declare namespace CfnService {
    ...
    interface CodeConfigurationValuesProperty {
         ...
         */
        readonly runtimeEnvironmentSecrets?: Array<CfnService.KeyValuePairProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
 ...
 * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apprunner-vpcingressconnection.html
 */
export declare class CfnVpcIngressConnection extends cdk.CfnResource implements cdk.IInspectable {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME = "AWS::AppRunner::VpcIngressConnection";
    /**
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
